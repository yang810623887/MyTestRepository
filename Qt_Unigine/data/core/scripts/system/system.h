...
void init(string name_, string languages_[], string locales_[])
{
	...
	splash_text = "<p align=center><font color=#606060 size=16><xy y=%100 dy=-20/>UNIGINE Corp. (c) 2005-2018</font></p>";
	splash_threshold = 16;
...
namespace Plugins
{
	...
	void projections_clicked()
	{
		...
		{
			SynckerInterface syncker = engine.syncker.getSyncker();
			syncker.setSetupMode(projections_cb.isChecked());
		}
		#endif
	}
