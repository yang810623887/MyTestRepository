...
namespace inviwo {
		...
		, internalStickyFlagUpdate_(false)
	{
		...
		QIcon icon;
		icon.addPixmap(QPixmap(":/Inviwo/Resources/stylesheets/images/dock-unsticky.png"), QIcon::Normal, QIcon::Off);
		icon.addPixmap(QPixmap(":/Inviwo/Resources/stylesheets/images/dock-sticky.png"), QIcon::Normal, QIcon::On);
		...
		QIcon icon2;
		icon2.addPixmap(QPixmap(":/Inviwo/Resources/stylesheets/images/dock-docked.png"), QIcon::Normal, QIcon::Off);
		icon2.addPixmap(QPixmap(":/Inviwo/Resources/stylesheets/images/dock-floating.png"), QIcon::Normal, QIcon::On);
		...
		closeBtn->setIcon(QIcon(":/Inviwo/Resources/stylesheets/images/close.png"));
